...
const SettingsModule: React.FC<SettingsModuleProps> = ({ 
  ...
  const tabs = [
    { id: 'maps', label: 'MAPS Configuration', icon: 'map' },
    { id: 'org', label: 'Organization Settings', icon: 'corporate_fare' },
    { id: 'system', label: 'System Settings', icon: 'security' },
    { id: 'account', label: 'Account Actions', icon: 'person' },
  ];
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 items-start">
      ...
      <div className="flex-1 w-full">
        {activeTab === 'maps' && (
          <section className="bg-white p-8 rounded-3xl border border-outline-variant/10 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
